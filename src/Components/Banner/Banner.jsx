    ...
    return (
        <div className='grid grid-cols-2 py-6 h-[80vh]'>
            ...
            <div className='flex text-left flex-col leading-snug  space-y-6 justify-center'>
                <h1 className='text-6xl uppercase tracking-widest text-black font-bold '>Unlock Your <span className='bg-gradient-to-r from-blue-600 to-teal-300 bg-clip-text text-transparent'>Best Self</span></h1>
                ...
                <div>
                <button className='bg-gradient-to-tr px-7 py-3 rounded-md from-blue-600 to-teal-300 hover:from-blue-200 hover:to-teal-50 hover:text-gray-600   text-white border-none'>Get Started</button>
                </div>
            </div>
            ...
            <div className='absolute top-2/3 left-[670px] bg-white p-6 drop-shadow-lg rounded-lg w-[200px]'>
