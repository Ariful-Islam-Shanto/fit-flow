    ...
    return (
        <div className='grid grid-cols-2 py-6 h-[80vh]'>
            ...
            <div className='flex text-left flex-col leading-snug  space-y-6 justify-center'>
                <h1 className='text-6xl uppercase tracking-widest text-black font-bold '>Unlock Your <span className='bg-gradient-to-r from-[#8dd049] to-[#aef766] bg-clip-text text-transparent'>Best Self</span></h1>
                ...
                <div>
                <button className='bg-[#84c544] px-7 py-3 rounded-md hover:from-blue-200 hover:to-teal-50 hover:text-gray-600   text-white border-none'>Get Started</button>
                </div>
            </div>
